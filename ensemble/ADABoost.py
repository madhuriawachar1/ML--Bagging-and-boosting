...
class AdaBoostClassifier():
    def __init__(self, base_estimator = DecisionTreeClassifier, n_estimators=10, classes =2): # Optional Arguments: Type of estimator
        '''
    ...
    def fit(self, X: pd.DataFrame, y:pd.Series):
        ...
        for estimator in range(self.n_estimators):
            clf = self.base_estimator(max_depth=2,criterion='entropy')
            #print(weight)
    ...
    def plot(self,X,y):
        ...
        # Saving Figures
        fig1.savefig(fname='fig1.png')
        fig2.savefig(fname='fig2.png')
        return fig1, fig2
        pass
