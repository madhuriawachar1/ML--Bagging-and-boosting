...
class RandomForestClassifier():
    def __init__(self, n_estimators=100, criterion='gini', max_depth=None, max_attr =3):
        '''
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_estimators):
            ...
            Dt=DecisionTreeClassifier(max_features='sqrt',criterion=self.criteria)
    ...
    def dec_boundary(self,X,y,pair=None):
        ...
        for  tree in self.Forest:
            ...
            ax1[i].set_ylabel(features[pair[1]])
            ax1[i].set_xlabel(features[pair[0]])
        ...
        ax2.set_ylabel(features[pair[1]])
        ax2.set_xlabel(features[pair[0]])
